* * is a pointer in a type declaration, a value of a pointer in an expression; & is the address of a pointer's reference in memory [#golang](https://twitter.com/hashtag/golang?src=hashtag_click)
